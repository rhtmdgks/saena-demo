      ...
      <div className="container mx-auto max-w-4xl">
        <div className="flex h-14 items-center justify-between px-6 liquid-glass-header rounded-full">
          ...
          <div className="hidden md:flex items-center gap-4">
            <button
              className="text-sm text-gray-300 hover:text-purple-300 transition-colors cursor-not-allowed opacity-50"
              disabled
              title="Coming soon"
            >
              Log in
            ...
            <Button
              asChild
              className="bg-lime-400 text-black font-medium rounded-lg px-4 py-2.5
            ...
            <Sheet>
              ...
              >
                ...
                <div className="mt-auto border-t border-gray-800 p-4">
                  <Button
                    asChild
                    className="w-full bg-lime-400 text-black font-medium rounded-lg px-4 py-2.5
                               hover:bg-lime-300 hover:shadow-md hover:scale-[1.02]
                               transition-all"
                  >
                    <Link href="/waitlist">Join Waitlist</Link>
