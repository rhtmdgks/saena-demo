            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-1">
                  ...
                  <NavItem href="/admin/prototype/search" icon={BarChart2}>
                    Search
                  </NavItem>
                  <NavItem href="/admin/prototype/industry" icon={Building2}>
                    Industry
                  </NavItem>
                  <NavItem href="/admin/prototype/topic" icon={MessagesSquare}>
                    Topic
                  </NavItem>
                  <NavItem href="/admin/prototype/model" icon={Folder}>
                    Model
                  </NavItem>
                  <NavItem href="/admin/prototype/citation" icon={CreditCard}>
                    Citation
                  </NavItem>
                  <NavItem href="/admin/prototype/improve" icon={Video}>
                    Improve
                  </NavItem>
                  <NavItem href="/admin/prototype/marketing" icon={TrendingUp}>
                    Marketing Strategy
                  </NavItem>
                  <NavItem href="/admin/prototype/stp" icon={Users2}>
                    STP Insight
                  </NavItem>
              ...
              <div className="border-t border-gray-200 dark:border-[#1F1F23] pt-6">
                <div className="space-y-1">
                  <NavItem
                    icon={TrendingUp}
                    hasSubmenu
          ...
          <div className="flex-1 overflow-y-auto py-4 px-4">
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-1">
                  <NavItem
                    href="/admin/prototype/analytics/overview"
                    icon={Home}
                  >
                    Overview
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/analytics/brand"
                    icon={CreditCard}
                  >
                    Brand
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/analytics/website"
                    icon={Building2}
                  >
                    Website
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/analytics/conversations"
                    icon={MessagesSquare}
                  >
                    Conversations
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/analytics/copilot"
                    icon={Video}
                  >
                    Copilot
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/analytics/uceg"
                    icon={TrendingUp}
                  >
                    UCEG
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/analytics/aida"
                    icon={BarChart2}
                  >
                    AIDA+
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/analytics/eda"
                    icon={MessagesSquare}
                  >
                    EDA+
                  </NavItem>
                  <NavItem href="/admin/prototype/analytics/pja" icon={Folder}>
                    PJA
                  </NavItem>
                  <NavItem href="/admin/prototype/analytics/bhi" icon={Shield}>
                    BHI
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/analytics/behavioral"
                    icon={Users2}
                  >
                    Behavioral
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/analytics/internal-pulse"
                    icon={Building2}
                  >
                    Internal Pulse
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/analytics/auto-weight"
                    icon={Settings}
                  >
                    Auto-Weight
                  </NavItem>
          ...
          <div className="flex-1 overflow-y-auto py-4 px-4">
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-1">
                  <NavItem href="/admin/prototype/shopping" icon={ShoppingCart}>
                    Overview
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/shopping/products"
                    icon={Package}
                  >
                    Products
                  </NavItem>
                  <NavItem
                    href="/admin/prototype/shopping/platforms"
                    icon={Building2}
                  >
                    Platforms
                  </NavItem>
